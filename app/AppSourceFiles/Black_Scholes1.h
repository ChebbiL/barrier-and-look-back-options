...
public:
	...
	virtual void gamma()const{
		std::cout << "gamma closed form result: \t \t" << gammaCF() << std::endl << "gamma simulation result(by PWLR): \t" << gammaPWLR() << std::endl << "gamma simulation result(by LRLR): \t" << gammaLR() << std::endl << std::endl;
	}
...
public:
	Barrier_option(double a = 100.0, double b = 100.0, double c = 0.05, double d = 0.4, double e = 1, double f = 0, double g = 80) :Black_Scholes(a, b, c, d, e, f), B(g){ N = 1000;M=100000; type = 1; }
	~Barrier_option(){}
...
public:
	...
	Lookback_option(double a = 100.0, double b = 100.0, double c = 0.05, double d = 0.4, double e = 1, double f = 0 ) :Black_Scholes(a, b, c, d, e, f){ N = 1000; M = 100000; type = 1; }
	~Lookback_option(){}
	void input(std::string x);
	void show()const{
		std::cout << std::endl;
...
public:
	Double_Barrier(double a = 100.0, double b = 100.0, double c = 0.05, double d = 0.4, double e = 1, double f = 0, double g = 50,double h=150) :Black_Scholes(a, b, c, d, e, f), L(g),U(h){ N = 1000; M = 100000; type = 1; }
	void input(std::string x);
	void show()const{
		std::cout << std::endl;
