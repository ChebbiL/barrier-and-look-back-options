...
\begin{figure}[h!]
  \centering
      ...
      \begin{subfigure}[b]{0.45\textwidth}
          \includegraphics[width=\textwidth]{graphs/barrieroldgammapwlr.png}
          \caption{Gamma with PW-LR method}
      \end{subfigure}
      \begin{subfigure}[b]{0.45\textwidth}
          \includegraphics[width=\textwidth]{graphs/barriergammapwlr.png}
          \caption{Gamma with PW-LR Rayleight method}
      \end{subfigure}
