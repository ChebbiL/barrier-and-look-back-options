...
$$Vega =  \frac{\partial C}{\partial \sigma}=N'(d_1)\sqrt{T}$$
...
$$Delta_{PW}=\frac{\partial C}{\partial S_0}=E[e^{-rT}\frac{S_T}{S_0}]$$
...
$$Vega_{PW} = \frac{\partial C}{\partial \sigma}=E[e^{-rT}S_T(\sqrt{T}Z-\sigma T)]$$
